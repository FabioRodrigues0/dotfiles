...
(let* ((bg         "#131410")
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-function-name-face ((t (:foreground ,base7))))
   `(font-lock-function-call-face ((t (:foreground ,base7))))
   `(font-lock-property-name-face ((t (:foreground ,base8))))
   `(font-lock-property-use-face  ((t (:foreground ,base7))))
